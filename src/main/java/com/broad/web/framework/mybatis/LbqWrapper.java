package com.broad.web.framework.mybatis;
...
import com.broad.web.framework.mybatis.handler.BaseLikeTypeHandler;
import com.broad.web.framework.tool.StrPool;
import lombok.extern.slf4j.Slf4j;
import com.broad.web.framework.bean.CommonDomain;
 ...
 * @author broad
 *
 * @date Created on 2020/01/07 17:11
 * @description 查询构造器
 */
@Slf4j
public class LbqWrapper<T> extends AbstractLambdaWrapper<T, LbqWrapper<T>>
    ...
    public LbqWrapper(T entity) {
        if (entity instanceof CommonDomain) {
            T cloneT = (T) ((CommonDomain) entity).clone();
